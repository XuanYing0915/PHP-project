...
require('../Order_CRUD_Main_Class_Dao.php');
...
$row_product = $orderDao->ticketProducts();
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:#4D9BAC">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="border-bottom:1px solid #82d1ce">
                    <div class="image">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <table class="table table-bordered table-striped" id="ticketOrderdetails">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class='align-middle'><?php echo $detail[4]; ?></td>
                                ...
                                <div class="d-flex justify-content-between flex-row me-2 pb-4" id="priceCalc">
                                    <div>
                                        <p id="detail_line"></p>
                                    </div>
                                    <div>
                                        <ul class="list-unstyled">
                                            ...
                                            <li >商品總價 &nbsp;<span id="productTotal_1"></span></li>
                                            
                                            <?php
                                            foreach ($row_order as $row) {
                                            ?>
                                            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;運費 &nbsp;<span id="shippingFee_1"><?php echo $row[9]; ?></span></li>
                                            <li class="fw-bold text-decoration-underline">訂單總價 &nbsp;<span id="grandTotal_1"></span></li>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="detailModalLabel">訂單明細</h1>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="detailForm">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select type="text" class="form-control" name="product_price" id="price" readonly>
                                                <?php
                                                        foreach($row_product as $product){
                                                    ?>
                                    ...
                                    <div class="modal-body">
                                        <form id="orderForm">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="member_id" id="memberID" disabled value="">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="order_total" id="orderTotal" value="" disabled>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <!-- <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="grand_total" id="grandTotal" value="" readonly>
                                            </div> -->
                                        </form>
                                    </div>
                                    <div class="modal-footer">
    ...
    <script>
        $(function() {
            ...
            $('#product').on('change',function(){
                const product_opts = document.getElementById('product').options;
                const price_opts = document.getElementById('price').options;
                for(i=0,n=product_opts.length;i<n;i++){
                    if(product_opts[i].selected){
                        price_opts.selectedIndex = i;
                    }
                }
            })
            ...
            //     const shipping_opts = document.getElementById('shipping').options;
            //     const shippingSelect = shipping_opts.selectedIndex;
            //     const fee = $('#shipping_fee').value;
            //     console.log(fee);
                // switch(shippingSelect){
                //     case 0:{
                //         document.getElementById('shipping_fee').innerText=50;
                //     }
                //     case 1:{
            ...
            function UpdatePrice(){
                const orderID = $('#orderID_get').text();
                const orderTotal = $('#productTotal_1').text();
                $.ajax({
                        url: 'PriceUpdateApi.php', //將資料傳給這支PHP的程式
                        type: 'GET', //透過POST的方法傳送資料
                        // data:user,   //傳送到Server端的資料
            ...
            function UpdatePriceCalc(){
                let totalPrice = 0;
                const detail_rows = $('#ticketOrderdetails>tbody>tr');
                const detail_lines = detail_rows.length;
                for(i=1,n=detail_rows.length;i<n+1;i++){
                    value = $('#ticketOrderdetails>tbody').children(`tr:nth-child(${i})`).children('td:nth-child(5)').text();
                    valueNum = Number(value);                   
                    totalPrice+=valueNum;
                }
                const docFrag = $(document.createDocumentFragment());
                
                document.getElementById('productTotal_1').innerText=totalPrice;
                const fee = Number(document.getElementById('shippingFee_1').innerText);
                const grandTotal = totalPrice + fee;
                document.getElementById('grandTotal_1').innerText=grandTotal;
                document.getElementById('detail_line').innerText=`共${detail_lines}筆`;
                document.getElementById('productTotal_2').innerText=totalPrice;
                document.getElementById('grandTotal_2').innerText=grandTotal;
            ...
            $('#editOrder').on('click', function() {
                ...
                const grandTotal = $('#orderInfo').children('div:nth-child(15)').children().children('span').text();
